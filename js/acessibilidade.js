(()=>{var A=class extends HTMLElement{shadow;isMuted=!1;isExpanded=!1;greetTimeoutId=null;pressTimeoutId=null;handleKeydown=e=>{(e.key==="Enter"||e.key===" "||e.key==="Spacebar")&&(e.preventDefault(),this.activate())};constructor(){super(),this.shadow=this.attachShadow({mode:"open"})}static get observedAttributes(){return["state","muted"]}attributeChangedCallback(e,t,i){e==="state"?this.setMascotState(i):e==="muted"&&(this.isMuted=i==="true",this.updateMutedIcon())}connectedCallback(){this.setAttribute("role","button"),this.setAttribute("aria-haspopup","menu"),this.setAttribute("aria-expanded","false"),this.setAttribute("aria-label","Capi, mascote do Acre Acess\xEDvel. Ativar para abrir o menu de acessibilidade."),this.setAttribute("tabindex","0"),this.render(),this.setupEvents(),this.addEventListener("keydown",this.handleKeydown),this.greetTimeoutId=window.setTimeout(()=>this.greet(),2200)}disconnectedCallback(){this.removeEventListener("keydown",this.handleKeydown),this.greetTimeoutId!==null&&window.clearTimeout(this.greetTimeoutId),this.pressTimeoutId!==null&&window.clearTimeout(this.pressTimeoutId)}render(){this.shadow.innerHTML=`
    ...
    `}setupEvents(){this.addEventListener("click",()=>this.activate())}activate(){this.isExpanded=!this.isExpanded,this.setAttribute("aria-expanded",String(this.isExpanded)),this.classList.add("pressed"),this.pressTimeoutId!==null&&window.clearTimeout(this.pressTimeoutId),this.pressTimeoutId=window.setTimeout(()=>this.classList.remove("pressed"),150),this.dispatchEvent(new CustomEvent("toggle-panel",{bubbles:!0,composed:!0,detail:{expanded:this.isExpanded}}))}setMascotState(e){let t=this.shadow.querySelector(".speech-bubble");t&&(e==="speaking"?(t.innerText="Estou lendo para voc\xEA...",t.style.opacity="1",t.style.transform="translateX(0) scale(1)"):e==="reading"?(t.innerText="Modo leitura ativo!",t.style.opacity="1",t.style.transform="translateX(0) scale(1)"):(t.innerText="Ol\xE1! Sou o Capi. Clique em mim!",t.style.opacity="",t.style.transform=""))}updateMutedIcon(){let e=this.shadow.getElementById("mutedIndicator");e&&(this.isMuted?e.classList.add("visible"):e.classList.remove("visible"))}setHighContrast(e){let t=this.shadow.host;e?t.classList.add("high-contrast"):t.classList.remove("high-contrast")}greet(){this.classList.add("greeting"),setTimeout(()=>this.classList.remove("greeting"),1300)}};customElements.define("capi-mascot",A);var P={IFAC:"I F A C",FEM:"F\xCAM",CPF:"C P F",CNPJ:"C N P J",CEP:"C E P",PDF:"P D F",URL:"U R L",HTML:"H T M L",CSS:"C S S",API:"A P I",TI:"T I",RH:"R H",EAD:"E A D",ENEM:"\xC9-N\xC9M",SUS:"S\xDAS",INSS:"I N S S",IBGE:"I B G E",MEC:"M\xC9QUI",ONG:"\xD3NGUI"},I={1:"primeiro",2:"segundo",3:"terceiro",4:"quarto",5:"quinto",6:"sexto",7:"s\xE9timo",8:"oitavo",9:"nono",10:"d\xE9cimo"},_={1:"primeira",2:"segunda",3:"terceira",4:"quarta",5:"quinta",6:"sexta",7:"s\xE9tima",8:"oitava",9:"nona",10:"d\xE9cima"},R=/\b(turma|vez|edição|etapa|fase|questão|rodada|vaga|semana|instância|chamada|convocação|via|cópia|série|versão)\b/i,V=["janeiro","fevereiro","mar\xE7o","abril","maio","junho","julho","agosto","setembro","outubro","novembro","dezembro"],b=class{static normalizeToChunks(e){let t=this.expandAll(e);return this.splitIntoSentences(t)}static normalize(e){return this.expandAll(e)}static profileForTag(e){switch(e){case"h1":return{rateMultiplier:.92,pitch:1.08};case"h2":return{rateMultiplier:.94,pitch:1.05};case"h3":case"h4":case"h5":case"h6":return{rateMultiplier:.96,pitch:1.03};case"li":return{rateMultiplier:1,pitch:1};case"blockquote":return{rateMultiplier:.95,pitch:.97};case"figcaption":return{rateMultiplier:.95,pitch:.98};default:return{rateMultiplier:1,pitch:1}}}static expandAll(e){let t=e;return t=this.expandCurrency(t),t=this.expandDates(t),t=this.expandPercentages(t),t=this.expandOrdinals(t),t=this.expandAbbreviations(t),t=this.expandAcronyms(t),t=this.expandDecimalNumbers(t),t=this.normalizePunctuationForProsody(t),t.replace(/\s+/g," ").trim()}static expandCurrency(e){return e.replace(/R\$\s?(\d{1,3}(?:\.\d{3})*)(?:,(\d{2}))?/g,(t,i,a)=>{let s=i;return a&&a!=="00"?`${s} reais e ${a} centavos`:`${s} reais`})}static expandPercentages(e){return e.replace(/(\d+(?:[.,]\d+)?)\s?%/g,(t,i)=>`${i} por cento`)}static expandDates(e){return e.replace(/\b(\d{1,2})\/(\d{1,2})\/(\d{2,4})\b/g,(t,i,a,s)=>{let o=parseInt(i,10),d=parseInt(a,10)-1,l=V[d]??a,p=s.length===2?`20${s}`:s;return`${o} de ${l} de ${p}`})}static expandOrdinals(e){return e=e.replace(/\b(Art\.?|Artigo)\s*(\d{1,3})\s*[ºª]?/gi,(t,i,a)=>`Artigo ${I[a]??a}`),e=e.replace(/\b(\d{1,3})(º|ª)/g,(t,i,a)=>a==="\xAA"?_[i]??`${i}\xAA`:I[i]??`${i}\xBA`),e}static hasFeminineNoun(e){return R.test(e)}static expandAbbreviations(e){let t=[[/\bSr\.\s/g,"Senhor "],[/\bSra\.\s/g,"Senhora "],[/\bDr\.\s/g,"Doutor "],[/\bDra\.\s/g,"Doutora "],[/\bProf\.\s/g,"Professor "],[/\bProfa\.\s/g,"Professora "],[/\bEx\.\s/g,"Excel\xEAncia "],[/\bpág\.\s?/gi,"p\xE1gina "],[/\bpp\.\s?/gi,"p\xE1ginas "],[/\bnº\s?/gi,"n\xFAmero "],[/\bn\.\s?/gi,"n\xFAmero "],[/\betc\.\b/gi,"etc\xE9tera"]];for(let[i,a]of t)e=e.replace(i,a);return e}static expandAcronyms(e){for(let[t,i]of Object.entries(P)){let a=new RegExp(`\\b${t}\\b`,"g");e=e.replace(a,i)}return e}static expandDecimalNumbers(e){return e.replace(/\b(\d{1,3}(?:\.\d{3})+),(\d+)\b/g,(t,i,a)=>`${i.replace(/\./g,"")} v\xEDrgula ${a}`)}static normalizePunctuationForProsody(e){let t=e;return t=t.replace(/\.{3,}/g,"\u2026"),t=t.replace(/!{2,}/g,"!"),t=t.replace(/\?{2,}/g,"?"),t=t.replace(/[–—]/g,","),t=t.replace(/\(([^)]+)\)/g,", $1,"),t=t.replace(/\s*,\s*,\s*/g,", "),t}static splitIntoSentences(e){if(!e.trim())return[];let i=e.replace(/\b(\w)\.(\w)\./g,"$1_DOT_$2_DOT_").split(/(?<=[.!?…])\s+(?=[A-ZÀ-Ú0-9])/).map(a=>a.replace(/_DOT_/g,".").trim()).filter(a=>a.length>0);return i.length===0?[{text:e,pauseAfterMs:0}]:i.map((a,s)=>{let o=s===i.length-1,d=/[.!?…]$/.test(a);return{text:a,pauseAfterMs:o?0:d?260:120}})}};var E=class{synth;currentUtterance=null;config;textElements=[];currentIndex=-1;currentState="idle";highlightClassName="acre-reading-highlight";_isSequentialReading=!1;useServerTts=!0;audioPlayer=null;constructor(e={}){if(console.log("\u{1F9AB} VoiceReader v6: Inicializando..."),this.synth=typeof window<"u"?window.speechSynthesis:null,this.config={rate:e.rate??1,volume:e.volume??1,pitch:e.pitch??1,lang:e.lang??"pt-BR",onStateChange:e.onStateChange??(()=>{}),onElementHighlight:e.onElementHighlight??(()=>{})},this.synth)try{(this.synth.speaking||this.synth.pending)&&this.synth.cancel()}catch{}this.injectHighlightStyles(),this.detectVoiceSupport(),this.setupMediaSession(),this.audioPlayer=typeof document<"u"?document.createElement("audio"):null;let t=()=>{if(this.synth)try{this.synth.paused&&this.synth.resume()}catch{}document.removeEventListener("click",t),document.removeEventListener("touchstart",t),document.removeEventListener("keydown",t)};typeof document<"u"&&(document.addEventListener("click",t),document.addEventListener("touchstart",t,{passive:!0}),document.addEventListener("keydown",t))}get isSequentialReading(){return this._isSequentialReading}getBackendUrl(){if(typeof window<"u"){let e=window.AcreAcessivelConfig?.backendUrl;return e!=null?e.replace(/\/$/,""):window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"?"http://localhost:8001":""}return"http://localhost:8001"}injectHighlightStyles(){if(document.getElementById("acre-highlight-styles"))return;let e=document.createElement("style");e.id="acre-highlight-styles",e.innerHTML=`
    ...
    `}setupEvents(){let e=this.shadow,t=e.getElementById("panelDrawer"),i=e.getElementById("capiBubble"),a=e.querySelector(".alt-trigger"),s=e.getElementById("closeBtn"),o=()=>{if(this.isOpen=!this.isOpen,this.isOpen){t.classList.add("open"),t.setAttribute("aria-hidden","false"),this.reader.stop(),i.classList.remove("visible");let n=e.getElementById("altTriggerBtn");n&&n.setAttribute("aria-expanded","true"),setTimeout(()=>{t.querySelector('button:not([disabled]), input:not([disabled]), [tabindex]:not([tabindex="-1"])')?.focus()},410)}else{t.classList.remove("open"),t.setAttribute("aria-hidden","true");let n=e.getElementById("altTriggerBtn");n&&n.setAttribute("aria-expanded","false")}};e.addEventListener("keydown",n=>{n.key==="Escape"&&this.isOpen&&o()}),this.addEventListener("close-panel",()=>{this.isOpen&&o()}),t.addEventListener("keydown",n=>{if(!this.isOpen||n.key!=="Tab")return;let c=Array.from(t.querySelectorAll('button:not([disabled]), input:not([disabled]), [tabindex]:not([tabindex="-1"])'));c.length&&(n.shiftKey&&document.activeElement===c[0]?(n.preventDefault(),c[c.length-1].focus()):!n.shiftKey&&document.activeElement===c[c.length-1]&&(n.preventDefault(),c[0].focus()))}),setTimeout(()=>{if(!this.isOpen&&this.reader.state==="idle"){i.classList.add("visible"),setTimeout(()=>i.classList.remove("visible"),6e3);let n=this.shadow.getElementById("capiMascot");n&&typeof n.greet=="function"&&n.greet()}},2e3),this.addEventListener("toggle-panel",o),a.addEventListener("click",o),s.addEventListener("click",o);let d=e.getElementById("playPauseBtn"),l=e.getElementById("stopBtn"),p=e.getElementById("prevBtn"),u=e.getElementById("nextBtn"),v=e.getElementById("rateSlider"),f=e.getElementById("pitchSlider"),y=e.getElementById("volumeSlider");d.addEventListener("click",()=>{this.reader.state==="speaking"?this.reader.pause():this.reader.state==="paused"?this.reader.resume():this.reader.play()}),l.addEventListener("click",()=>this.reader.stop()),p.addEventListener("click",()=>this.reader.previous()),u.addEventListener("click",()=>this.reader.next()),v.addEventListener("input",n=>{let r=parseFloat(n.target.value),c=e.getElementById("rateVal");c&&(c.innerText=`${r.toFixed(2)}x`),this.reader.setRate(r),this.saveSettings()}),f.addEventListener("input",n=>{let r=parseFloat(n.target.value),c=e.getElementById("pitchVal");c&&(c.innerText=r.toFixed(2)),this.reader.setPitch(r),this.saveSettings()}),y.addEventListener("input",n=>{let r=parseFloat(n.target.value),c=e.getElementById("volumeVal");c&&(c.innerText=`${Math.round(r*100)}%`),this.reader.setVolume(r),this.saveSettings()}),e.getElementById("btnFontInc")?.addEventListener("click",()=>{this.fontScale=Math.min(this.fontScale+.1,2),this.applySettingsToPage(),this.saveSettings()}),e.getElementById("btnFontDec")?.addEventListener("click",()=>{this.fontScale=Math.max(this.fontScale-.1,.8),this.applySettingsToPage(),this.saveSettings()}),e.getElementById("btnContrast")?.addEventListener("click",()=>{this.isHighContrast=!this.isHighContrast,this.applySettingsToPage(),this.saveSettings()}),e.getElementById("btnGrayscale")?.addEventListener("click",()=>{this.isGrayscale=!this.isGrayscale,this.applySettingsToPage(),this.saveSettings()}),e.getElementById("btnLineSpacing")?.addEventListener("click",()=>{this.lineSpacing=this.lineSpacing==="normal"?"medium":this.lineSpacing==="medium"?"large":"normal",this.applySettingsToPage(),this.saveSettings()}),e.getElementById("btnLetterSpacing")?.addEventListener("click",()=>{this.letterSpacing=this.letterSpacing==="normal"?"medium":this.letterSpacing==="medium"?"large":"normal",this.applySettingsToPage(),this.saveSettings()}),e.getElementById("btnDyslexic")?.addEventListener("click",()=>{this.isDyslexicFriendly=!this.isDyslexicFriendly,this.applySettingsToPage(),this.saveSettings()}),e.getElementById("btnToggleMascot")?.addEventListener("click",()=>{this.showMascot=!this.showMascot,this.applySettingsToPage(),this.saveSettings()});let g=e.getElementById("btnHoverSpeak"),k=()=>{this.readOnHover=!this.readOnHover,this.applySettingsToPage(),this.saveSettings()};g.addEventListener("click",k),g.addEventListener("keydown",n=>{(n.key==="Enter"||n.key===" ")&&(n.preventDefault(),k())}),e.getElementById("btnLibras")?.addEventListener("click",()=>{this.isLibrasActive=!this.isLibrasActive,this.reader.readTextDirectly(this.isLibrasActive?"Tradu\xE7\xE3o em Libras ativada":"Tradu\xE7\xE3o em Libras desativada"),document.dispatchEvent(new CustomEvent("acre:libras:state",{detail:{active:this.isLibrasActive}})),this.applySettingsToPage(),this.saveSettings()}),document.addEventListener("click",n=>{if(this.reader.isSequentialReading)return;let r=n.target;if(r.closest("acre-accessibility-panel")||r.closest("capi-mascot")||r.closest(".audio-player-wrapper")||r.closest("audio")||r.closest("[vw]")||r.closest("#vlibras-div"))return;let h=r.closest('h1,h2,h3,h4,h5,h6,p,li,blockquote,article span,label,figcaption,a,button,img[alt],[role="button"]');h&&this.reader.readSpecificElement(h,!1)});let w=null,L=()=>{w&&window.clearTimeout(w),w=window.setTimeout(()=>{if(this.reader.isSequentialReading)return;let n=window.getSelection()?.toString().trim();if(!n||n.length<=2)return;let r=window.getSelection();if(r?.anchorNode){let c=r.anchorNode.parentElement;if(c?.closest("acre-accessibility-panel")||c?.closest("capi-mascot")||c?.closest(".vpw-plugin-wrapper")||c?.closest("#vlibras-div"))return}this.reader.readTextDirectly(n)},800)};document.addEventListener("selectionchange",L),document.addEventListener("click",n=>{if(!this.readOnHover||this.reader.isSequentialReading)return;let r=n.target;if(r.closest("acre-accessibility-panel")||r.closest("capi-mascot")||r.closest(".audio-player-wrapper")||r.closest("audio")||r.closest("[vw]")||r.closest("#vlibras-div"))return;let h=r.closest('h1,h2,h3,h4,h5,h6,p,li,blockquote,article span,label,figcaption,a,button,img[alt],[role="button"]');h&&(this.hoverTimeout&&clearTimeout(this.hoverTimeout),this.reader.readSpecificElement(h,!1))}),document.addEventListener("mouseover",n=>{if(!this.readOnHover||this.reader.isSequentialReading)return;let r=n.target;if(r.closest("acre-accessibility-panel")||r.closest("capi-mascot")||r.closest(".audio-player-wrapper")||r.closest("audio")||r.closest("[vw]")||r.closest("#vlibras-div"))return;let h=r.closest('h1,h2,h3,h4,h5,h6,p,li,blockquote,article span,label,figcaption,a,button,img[alt],[role="button"]');h&&h!==this.lastHoveredElement&&(this.lastHoveredElement=h,this.hoverTimeout&&clearTimeout(this.hoverTimeout),this.hoverTimeout=setTimeout(()=>{this.reader.isSequentialReading||this.reader.readSpecificElement(h,!1)},300))}),document.addEventListener("mouseout",n=>{if(!this.readOnHover)return;let r=n.target,c=n.relatedTarget,h='h1,h2,h3,h4,h5,h6,p,li,blockquote,article span,label,figcaption,a,button,img[alt],[role="button"]',x=r.closest(h),T=c?c.closest(h):null;x&&x===this.lastHoveredElement&&!T&&(this.hoverTimeout&&clearTimeout(this.hoverTimeout),this.lastHoveredElement=null)}),document.addEventListener("focusin",n=>{if(!this.readOnHover||this.reader.isSequentialReading)return;let r=n.target;if(r.closest("acre-accessibility-panel")||r.closest("capi-mascot"))return;let h=r.closest('h1,h2,h3,h4,h5,h6,p,li,blockquote,article span,label,figcaption,a,button,img[alt],[role="button"]');h&&(this.hoverTimeout&&clearTimeout(this.hoverTimeout),this.reader.readSpecificElement(h,!1))})}setupKeyboardShortcuts(){window.addEventListener("keydown",e=>{if(e.altKey)switch(e.key.toLowerCase()){case"a":e.preventDefault(),this.dispatchEvent(new CustomEvent("toggle-panel",{bubbles:!0,composed:!0}));break;case"p":e.preventDefault(),this.reader.state==="speaking"?this.reader.pause():this.reader.state==="paused"?this.reader.resume():this.reader.play();break;case"s":e.preventDefault(),this.reader.stop();break;case"n":e.preventDefault(),this.reader.next();break;case"b":e.preventDefault(),this.reader.previous();break;case"c":e.preventDefault(),this.isHighContrast=!this.isHighContrast,this.applySettingsToPage(),this.saveSettings();break}})}handleVoiceStateChange(e){let t=this.shadow,i=t.getElementById("playPauseBtn"),a=t.getElementById("iconPlay");!i||!a||(e==="speaking"?(a.setAttribute("viewBox","0 0 24 24"),a.setAttribute("fill","currentColor"),a.innerHTML='<rect x="6" y="4" width="4" height="16" rx="1"/><rect x="14" y="4" width="4" height="16" rx="1"/>',i.setAttribute("aria-label","Pausar leitura"),i.setAttribute("title","Pausar leitura (Alt+P)"),this.setMascotState("speaking"),t.getElementById("capiBubble")?.classList.remove("visible")):e==="paused"?(a.setAttribute("viewBox","0 0 24 24"),a.setAttribute("fill","currentColor"),a.innerHTML='<polygon points="5 3 19 12 5 21 5 3"/>',i.setAttribute("aria-label","Retomar leitura"),i.setAttribute("title","Retomar leitura (Alt+P)"),this.setMascotState("idle")):(a.setAttribute("viewBox","0 0 24 24"),a.setAttribute("fill","currentColor"),a.innerHTML='<polygon points="5 3 19 12 5 21 5 3"/>',i.setAttribute("aria-label","Iniciar leitura"),i.setAttribute("title","Ler p\xE1gina (Alt+P)"),this.setMascotState("idle")))}handleElementHighlight(e){e?this.setMascotState(this.reader.state==="speaking"?"speaking":"reading"):this.setMascotState("idle")}applySettingsToPage(){let e=this.shadow,t=document.body,i=document.documentElement;i.style.setProperty("--acre-font-multiplier",this.fontScale.toString());let a=e.getElementById("btnContrast");if(this.isHighContrast){i.classList.add("acre-high-contrast-mode"),this.classList.add("high-contrast"),a?.classList.add("active"),a?.setAttribute("aria-pressed","true");let m=e.getElementById("capiMascot");m?.setHighContrast&&m.setHighContrast(!0)}else{i.classList.remove("acre-high-contrast-mode"),this.classList.remove("high-contrast"),a?.classList.remove("active"),a?.setAttribute("aria-pressed","false");let m=e.getElementById("capiMascot");m?.setHighContrast&&m.setHighContrast(!1)}let s=e.getElementById("btnGrayscale");this.isGrayscale?(t.classList.add("acre-grayscale-mode"),s?.classList.add("active"),s?.setAttribute("aria-pressed","true")):(t.classList.remove("acre-grayscale-mode"),s?.classList.remove("active"),s?.setAttribute("aria-pressed","false"));let o=e.getElementById("lineSpacingLabel"),d=e.getElementById("btnLineSpacing"),l={normal:["normal","Normal",!1],medium:["1.8","M\xE9dio",!0],large:["2.3","Largo",!0]},[p,u,v]=l[this.lineSpacing];i.style.setProperty("--acre-line-spacing",p),o&&(o.innerText=u),d?.classList.toggle("active",v);let f=e.getElementById("letterSpacingLabel"),y=e.getElementById("btnLetterSpacing"),g={normal:["normal","Normal",!1],medium:["0.12em","M\xE9dio",!0],large:["0.2em","Largo",!0]},[k,w,L]=g[this.letterSpacing];i.style.setProperty("--acre-letter-spacing",k),f&&(f.innerText=w),y?.classList.toggle("active",L);let n=e.getElementById("btnDyslexic");t.classList.toggle("acre-dyslexic-mode",this.isDyslexicFriendly),n?.classList.toggle("active",this.isDyslexicFriendly),n?.setAttribute("aria-pressed",String(this.isDyslexicFriendly));let r=e.getElementById("mascotTrigger"),c=e.getElementById("altTriggerContainer"),h=e.getElementById("mascotBtnLabel");this.showMascot?(r?.classList.remove("hidden"),c?.classList.add("hidden"),h&&(h.innerText="Ocultar Mascote"),e.getElementById("btnToggleMascot")?.classList.remove("active")):(r?.classList.add("hidden"),c?.classList.remove("hidden"),h&&(h.innerText="Mostrar Mascote"),e.getElementById("btnToggleMascot")?.classList.add("active"));let x=e.getElementById("hoverSpeakLabel"),T=e.getElementById("btnHoverSpeak");x&&(x.innerText=this.readOnHover?"On":"Off"),x?.classList.toggle("on",this.readOnHover),T?.setAttribute("aria-pressed",String(this.readOnHover));let F=e.getElementById("librasLabel"),B=e.getElementById("btnLibras");if(F&&(F.innerText=this.isLibrasActive?"On":"Off"),B?.classList.toggle("active",this.isLibrasActive),B?.setAttribute("aria-pressed",String(this.isLibrasActive)),this.isLibrasActive){let m=document.querySelector("[vw]");m?m.style.display="block":this.injectVLibras()}else{let m=document.querySelector("[vw]");m&&(m.style.display="none")}}saveSettings(){let e=this.shadow.getElementById("rateSlider"),t=this.shadow.getElementById("pitchSlider"),i=this.shadow.getElementById("volumeSlider");localStorage.setItem("acre_acessivel_settings",JSON.stringify({fontScale:this.fontScale,isHighContrast:this.isHighContrast,isGrayscale:this.isGrayscale,lineSpacing:this.lineSpacing,letterSpacing:this.letterSpacing,isDyslexicFriendly:this.isDyslexicFriendly,showMascot:this.showMascot,readOnHover:this.readOnHover,isLibrasActive:this.isLibrasActive,rate:parseFloat(e?.value||"1.0"),pitch:parseFloat(t?.value||"1.0"),volume:parseFloat(i?.value||"1.0")}))}loadSettings(){let e=localStorage.getItem("acre_acessivel_settings");if(e)try{let t=JSON.parse(e);this.fontScale=t.fontScale??1,this.isHighContrast=t.isHighContrast??!1,this.isGrayscale=t.isGrayscale??!1,this.lineSpacing=t.lineSpacing??"normal",this.letterSpacing=t.letterSpacing??"normal",this.isDyslexicFriendly=t.isDyslexicFriendly??!1,this.showMascot=t.showMascot??!0,this.readOnHover=t.readOnHover??!1,this.isLibrasActive=t.isLibrasActive??!1;let i=this.shadow.getElementById("rateSlider"),a=this.shadow.getElementById("rateVal");i&&t.rate!==void 0&&(i.value=t.rate.toString(),a&&(a.innerText=`${t.rate.toFixed(2)}x`),this.reader.setRate(t.rate));let s=this.shadow.getElementById("pitchSlider"),o=this.shadow.getElementById("pitchVal");s&&t.pitch!==void 0&&(s.value=t.pitch.toString(),o&&(o.innerText=t.pitch.toFixed(2)),this.reader.setPitch(t.pitch));let d=this.shadow.getElementById("volumeSlider"),l=this.shadow.getElementById("volumeVal");d&&t.volume!==void 0&&(d.value=t.volume.toString(),l&&(l.innerText=`${Math.round(t.volume*100)}%`),this.reader.setVolume(t.volume))}catch(t){console.error("Erro ao ler configura\xE7\xF5es:",t)}}injectVLibras(){if(document.querySelector("[vw]"))return;let e=document.createElement("div");e.id="vlibras-div",e.setAttribute("vw",""),e.classList.add("enabled"),e.innerHTML='<div vw-access-button class="active"></div><div vw-plugin-wrapper><div class="vw-plugin-top-wrapper"></div></div>',document.body.appendChild(e);let t=document.createElement("script");t.src="https://vlibras.gov.br/app/vlibras-plugin.js",t.onload=()=>{window.VLibras?.Widget&&new window.VLibras.Widget("https://vlibras.gov.br/app")},document.head.appendChild(t)}};customElements.define("acre-accessibility-panel",M);var C=class{panelInstance=null;get panel(){return this.panelInstance}init(e={}){if(!(typeof window>"u")){if(document.querySelector("acre-accessibility-panel")){console.warn("Acre Acess\xEDvel j\xE1 inicializado nesta p\xE1gina.");return}this.panelInstance=document.createElement("acre-accessibility-panel"),e.libras&&this.injectVLibras(),document.body.appendChild(this.panelInstance),console.log("\u{1F49A} Acre Acess\xEDvel inicializado com sucesso! Mascote Capi pronto para ajudar.")}}injectVLibras(){if(document.getElementById("vlibras-div"))return;let e=document.createElement("div");e.id="vlibras-div",e.setAttribute("vw",""),e.classList.add("enabled"),e.innerHTML=`
      <div vw-access-button class="active"></div>
      <div vw-plugin-wrapper>
        <div class="vw-plugin-top-wrapper"></div>
      </div>
    `,document.body.appendChild(e);let t=document.createElement("script");t.src="https://vlibras.gov.br/app/vlibras-plugin.js",t.onload=()=>{new window.VLibras.Widget("https://vlibras.gov.br/app")},document.head.appendChild(t)}},H=new C;window.AcreAcessivel=H;var Y=H;})();
